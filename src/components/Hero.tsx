  ...
  return <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        animationDelay: "0.2s"
          ...
          <img alt="Tavares Pizzaria" src="/lovable-uploads/5f90581f-0c87-4f5b-9f44-6a29e1493657.png" className="mx-auto h-40 md:h-56 w-auto mb-6 drop-shadow-2xl bg-background/90 p-4 rounded-full object-scale-down border-0 border-primary" />
        </div>
        ...
        <p className="text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto animate-fade-in" style={{
        animationDelay: "0.6s"
      }}>
